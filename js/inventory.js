...
classificationList.addEventListener("change", function() {
    ...
    .then(function (response) {
        ...
        } throw Error("Network repsponse was not OK");
    })
    .then(function (data) {
        console.log(data);
...
function buildInventoryList(data) {
    ...
    let dataTable = '<thead>';
    dataTable += '<tr><th class="carName">Vehicle Name</th><td>&nbsp;</td><td>&nbsp;</td><tr>';
    dataTable += '</thead>';
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<tr><td class="carName">${element.invMake} ${element.invModel}</td>`;
